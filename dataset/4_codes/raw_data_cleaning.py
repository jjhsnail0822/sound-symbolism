...
datas = {}
for lang in langs:
    with open(f'dataset/1_preprocess/nat/{lang}_with_not_found.json', 'r', encoding='utf-8') as f:
...
with open('dataset/1_preprocess/nat/statistics.txt', 'w', encoding='utf-8') as f:
    for lang in langs:
