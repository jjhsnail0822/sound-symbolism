...
def generate_datasets(language, task, experiment_name):
    ...
    if not os.path.exists('dataset/3_questions/nat/understanding_ipa_pair_matching_no_dialogue'):
        os.makedirs('dataset/3_questions/nat/understanding_ipa_pair_matching_no_dialogue')
    with open(f'dataset/3_questions/nat/understanding_ipa_pair_matching_no_dialogue/{EXPERIMENT_NAME}-{LANGUAGE}.json', 'w', encoding='utf-8') as f:
