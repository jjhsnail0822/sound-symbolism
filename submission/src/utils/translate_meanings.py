...
for LANGUAGE in LANGUAGES:
    ...
    with open(f'data/processed/{LANGUAGE}.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    ...
    with open(f'data/processed/nat/{LANGUAGE}.json', 'w', encoding='utf-8') as f:
        json.dump(data, f, ensure_ascii=False, indent=4)
    print(f"Translated meanings saved to data/processed/nat/{LANGUAGE}.json")