...
# 1) Load embeddings
emb_path = f'dataset/1_preprocess/nat/{LANGUAGE}_embeddings.pkl'
with open(emb_path, 'rb') as f:
    embeddings = pickle.load(f)

# 2) Load pre-computed clusters
clustered_path = f'dataset/1_preprocess/nat/{LANGUAGE}_clustered.json'
...
# 5) 결과 저장 및 출력
out_png = f'analysis/plots/{LANGUAGE}_kmeans_scatter.png'
