...
if __name__ == "__main__":
    # 제공된 파일 경로
    file_path_qwen = 'dataset/1_preprocess/nat/semantic_dimension_gt/semantic_dimension_gt_Qwen3-32B.json'
    file_path_gemma = 'dataset/1_preprocess/nat/semantic_dimension_gt/semantic_dimension_gt_gemma-3-27b-it.json'
