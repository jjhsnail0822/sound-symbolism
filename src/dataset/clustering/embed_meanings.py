...
with open(f'data/processed/nat/{LANGUAGE}.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open(f'data/processed/nat/clustering/{LANGUAGE}_embeddings.pkl', 'wb') as f:
    pickle.dump(embeddings, f)

with open(f'data/processed/nat/clustering/{LANGUAGE}_embeddings_old.pkl', 'rb') as f:
