...
def generate_datasets(language, task, experiment_name):
    ...
    if not os.path.exists('data/prompts/understanding/pair_matching/original'):
        os.makedirs('data/prompts/understanding/pair_matching/original')
    with open(f'data/prompts/understanding/pair_matching/original/{EXPERIMENT_NAME}-{LANGUAGE}.json', 'w', encoding='utf-8') as f:
