...
class DialogueGenerator:
    def __init__(self, language: str,
        ...
        # Set paths
        self.input_path = os.path.join('data/processed/nat/', f"{self.language}.json")
        self.output_path = 'data/dialogues/'
